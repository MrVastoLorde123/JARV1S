...
## Verification
Focused verification should cover canonical type enforcement, consumed-source enforcement, distinct identity, explicit metadata, lineage rechecks, immutable candidate evidence, source non-mutation, recursive freezing, rejection behavior, and authority-boundary walls.
