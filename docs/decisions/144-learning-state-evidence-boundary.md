...
- Requires source integrity to be `VALID` before evidence may be recorded as `RECORDED`; invalid or internally inconsistent integrity fails closed into explicit `REJECTED` evidence.
