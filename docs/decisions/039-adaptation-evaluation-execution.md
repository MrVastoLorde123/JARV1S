...
- Create a deterministic execution ID distinct from the preparation ID and historical source execution ID.
...
- Convert applier exceptions into an explicit `FAILED` result rather than leaking exceptions through the boundary.
...
M22.33 is locally verified at 11/11 focused + 502/502 core = 513/513.
