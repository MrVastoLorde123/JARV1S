...
## Verification
Focused verification covers exact request/response types, required metadata, operation typing, recursive immutability, response identity preservation, malformed-request rejection, injected-port routing, and authority/execution boundary walls.

M25.1 local verification: 14 focused tests, 210 M23.169–M25.1 regression tests, and 2,861 core tests passing.
