...
export interface ResearchTopicContract {
  id: string;
  title: string;
...
export interface ModelAssignmentContract {
  id: string;
  name: string;
  provider: string;
  role: string;
...
export interface WorkRuntimeContract {
...
export const initialSnapshot: JarvisSnapshot = {
  ...
  models: [
    { id: 'reasoning', name: 'Local Reasoner', provider: 'Local', role: 'Reasoning / planning', state: 'IDLE', detail: 'Reserved for future model-backed cognition.' },
    { id: 'coding', name: 'Coding Model', provider: 'Local', role: 'Workspace coding', state: 'IDLE', detail: 'Reserved for workspace engineering.' },
