...
class ContextSourceIntegration:
    """Enforce source selection before persistent items enter working context."""
    ...
    def compose(self, request: str, sources: Iterable[ContextSource], context_items: Mapping[str, ContextItem] | Iterable[ContextItem], *, now: float | None = None, options: ContextOptions | None = None, history_items=None, conversation_state: StateSnapshot | None = None, task: TaskRequest | None = None, execution_state: ExecutionState | None = None, execution_progress: ExecutionProgress | None = None, observations=None, metadata: Mapping[str, Any] | None = None) -> WorkingContext:
