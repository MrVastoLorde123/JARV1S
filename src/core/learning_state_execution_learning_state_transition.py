...
class LearningStateExecutionLearningStateTransition:
    ...
    def __post_init__(self) -> None:
        required_strings = (
            ...
            "consumption_request_id", "source_validation_id", "state_key", "transition_fingerprint", "consumer_id", "execution_target_id",
            "execution_purpose", "objective", "evaluator_id", "evaluation_purpose", "signal_purpose", "learner_id", "eligibility_purpose",
            "proposer_id", "proposal_purpose", "decision_maker_id", "decision_purpose", "applier_id", "application_purpose",
            "evidence_collector_id", "evidence_purpose", "transition_actor_id", "transition_purpose",
        )
