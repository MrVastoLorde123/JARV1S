...
class ModelExecutionPlanner:
    ...
    def plan(
        ...
        prompt = (
            ...
            "than inventing unrelated work. Do not assume unobserved work is "
            "complete. The grounded remaining-work assessment is the only "
            "remaining-work input to planning.\n\n"
