...
class LearningStateExecutionLearningStateValidationService:
    ...
    def validate(
        ...
        *,
        ...
        lineage_application_id = integrity.lineage.get(
            "application_id",
            integrity.application_id,
        )
        lineage_source_integrity_id = integrity.lineage.get(
            "source_integrity_id",
            integrity.source_integrity_id,
        )
        if lineage_application_id != integrity.application_id:
            checks.append("application lineage mismatch")
        if lineage_source_integrity_id != integrity.source_integrity_id:
            checks.append("source integrity lineage mismatch")
