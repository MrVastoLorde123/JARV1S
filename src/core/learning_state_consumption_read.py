...
class LearningStateConsumptionReadService:
    ...
    def consume(
        self,
        request: LearningStateConsumptionRequest,
        *,
        read_id: str,
        reader: Callable[[Mapping[str, str]], object] | None,
        ...
        failure = None if consumed else reason
        return LearningStateConsumptionRead(
            read_id=read_id,
            request_id=request.request_id,
            validation_id=request.validation_id,
            integrity_id=request.integrity_id,
            ...
            reasons=reasons if reasons is not None else {"read_status": status.value},
            lineage=lineage if lineage is not None else {"read_id": read_id, "request_id": request.request_id},
        )


__all__ = [
    "LearningStateConsumptionReadError",
    "LearningStateConsumptionReadStatus",
    "LearningStateConsumptionRead",
    "LearningStateConsumptionReadService",
]
