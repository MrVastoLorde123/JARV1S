"""Confirmation-gated file move tool confined to a shared workspace."""
...
class MoveFileHandler:
    """Moves/renames a file within the tool's configured workspace directory."""
    ...
    def __init__(
        ...
        *,
        ...
        self._definition = ToolDefinition(
            name=self.TOOL_NAME,
            description=(
                "Moves or renames a file to a destination path within the tool's "
                "configured workspace directory. Creates parent directories if "
                "requested. This tool changes filesystem state and requires confirmation."
            ),
            version="1.0.0",
            input_schema={
                "type": "object",
